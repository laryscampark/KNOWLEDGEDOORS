...
private String talvezdevolucao;
private String vencimento;
private int statusdevolucao;

    public Devolucao() {
    }

    public Devolucao(String codigoemprestimo, String codigolivro, String titulo, String classificacao, String cpffuncionario, String funcionario, String cpf, String nomecompleto, int statusemprestimo, String dataemprestimo, String datadadevolucao, String talvezdevolucao, String vencimento, int statusdevolucao) {
        ...
        this.talvezdevolucao = talvezdevolucao;
    ...
    /**
     * @return the talvezdevolucao
     */
    public String getTalvezdevolucao() {
        return talvezdevolucao;
    }

    /**
     * @param talvezdevolucao the talvezdevolucao to set
     */
    public void setTalvezdevolucao(String talvezdevolucao) {
        this.talvezdevolucao = talvezdevolucao;
    }
    ...
    /**
     * @param statusdevolucao the statusdevolucao to set
     */
    public void setStatusdevolucao(int statusdevolucao) {
        this.statusdevolucao = statusdevolucao;
    }
